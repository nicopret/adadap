...
async.series({
    ...
    fs.writeFile(results.dir + '/logs/00.log', '', err => err ? console.error(err) : console.log('done'));
    createAccounts(results.dir, results.count, () => {
        fs.writeFile(results.dir + '/CustomGenesis.json', JSON.stringify(genesis, null, 2), () => {
            exec('geth --identity “LocalTestNode” --rpc --rpcport 8080 --rpccorsdomain “*” --datadir ./' + results.dir + '/data/ --port 30303 --nodiscover --rpcapi db,eth,net,web3,personal,admin,miner --networkid 1999 --maxpeers 0 --verbosity 6 init ./' + results.dir + '/CustomGenesis.json 2>> ./' + results.dir + '/logs/00.log', (err, stdout, stderr) => {
                ...
                spawn('geth --identity “LocalTestNode” --rpc --rpcport 8080 --rpccorsdomain “*” --datadir ./' + results.dir + '/data/ --port 30303 --nodiscover --rpcapi db,eth,net,web3,personal --networkid 1999 --maxpeers 0 console', [], {shell: true});
                ...
                fs.writeFile('start_' + results.dir + '.bat', 'geth --identity “LocalTestNode” --rpc --rpcport 8080 --rpccorsdomain “*” --datadir ./' + results.dir + '/data/ --port 30303 --nodiscover --rpcapi db,eth,net,web3,personal --networkid 1999 --maxpeers 0 console', err => err ? console.error(err) : console.log('done'));
                ...
                fs.writeFile('mist_' + results.dir + '.bat', 'Mist --rpc http://localhost:8080 --swarmurl “null”', err => err ? console.error(err) : console.log('done'));
