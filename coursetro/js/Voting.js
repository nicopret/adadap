...
var contractInstance = Contract.at('0xa1A4d7F70ac96A47b92aD483eDd05C23BB160226');

console.log(contractInstance.candidateList(0xa1A4d7F70ac96A47b92aD483eDd05C23BB160226));
contractInstance.candidateList(0x22CDFa500B9A22B2f7D9b4A4010A92a181a613E6).call().then((err, res) => console.log(err ? err : res));
...
function candidateList() {
	contractInstance.candidateList(0x22CDFa500B9A22B2f7D9b4A4010A92a181a613E6, {
		from: '0x22CDFa500B9A22B2f7D9b4A4010A92a181a613E6'
	})
	.then((res) => {
		console.log(res);
